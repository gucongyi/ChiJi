...
public static class PhotonNetwork
{
    ...
    /// </param>
    private static List<string> loadBattleCache=new List<string>();

    public static void ClearBattleListCache()
    {
        loadBattleCache.Clear();
    }

    public static void LoadLevel(string levelName)
    {
        if (loadBattleCache.Contains(levelName))
        {
            return;
        }
        else
        {
            loadBattleCache.Add(levelName);
        }
        networkingPeer.SetLevelInPropsIfSynced(levelName);
        Debug.Log("PhotonNetwork Load Battle");
        ...
        if (levelName== "Battle")
        {
            AppController.mInstance.MySceneController.LoadSceneAynsc("Battle", (float progress) =>
            {
            ...
            }, () =>
            {
                ...
                ResourceManager.Ins.RemoveDicPrefabGo("CanvasLobby");
                ...
                //    Canvas lobbyCanvas = go.GetComponent<Canvas>();
                //    lobbyCanvas.worldCamera = UIRoot.mInstance.UiCamera;
